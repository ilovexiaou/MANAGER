...
<div id="cc" >
    ...
    <div style="margin:10px 0;"></div>
    <div id="easyuitable">
        <table id="dg" class="easyui-datagrid" title="信息" style="width:98%;">
    </div>
    </table>
</div>
...
$(function(){
    ...
    //初始化table
    $('#dg').datagrid({
        url:basePath+'message/ajax.do?createdId='+createdId,
        method:'post',
        ...
        columns:[[
            ...
            {field:'name',title:'消息标题',width:100},
            {field:'comment',title:'消息内容'},
            {field:'createdId',title:'创建人',width:100},
...
/* var toolbar = [{
            ...
            iconCls:'icon-add',
            handler:function(){
                window.location.href = basePath + 'vacation/addVacation.do';
            }
        },{
            text:'修改',
            iconCls:'icon-edit',
